...
var myBarChart = new Chart(ctx, {
  ...
  data: {
    labels: [
        "<?=esc($student_count_by_gender[0]['gender_status'])?>",
        "<?=esc($student_count_by_gender[1]['gender_status'])?>"],
    datasets: [{
      label: "No. Students",
      ...
      borderColor: "#4e73df",
      data: [
        <?=esc($student_count_by_gender[0]['count'])?>,
        <?=esc($student_count_by_gender[1]['count'])?>],
    }],
  },
  options: {
